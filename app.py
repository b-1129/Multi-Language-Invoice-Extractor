...
st.set_page_config(page_title="Multilanguage_Invoice_Extractor")
st.header("Multilanguage_Invoice_Extractor")
...
input_prompt="""
You are a expert in unnderstanding Invoices. We will upload Image of Invoices
